...
B2B = [
    ("b2b-atelier",   "art",      "3D-ательє подарунка",                "Конструктор корпоративного подарунка на живому 3D-шовку: принт, річ, кількість, текст листівки — ціна рахується одразу, конфігурацію можна переслати колегам посиланням і надіслати на розрахунок."),
    ("b2b-garden",    "garden",   "3D-історія для бізнесу",             "Корпоративна версія Garden: одна 3D-сцена на весь скрол — логотип із частинок, карусель принтів, тунель бюджетів, «Співоча душа», жовта коробка з листівкою, форма запиту."),
    ...
    ("b2b-certificates", "studio", "Сертифікати для команд",            "Подарункові сертифікати: номінали від 700 до 4 400 грн, електронні або друковані, без збору розмірів і адрес — для віддалених команд і клієнтів."),
    ("b2b-agencies",  "form",     "Для агенцій",                        "Партнерська програма для event-, HR- і подарункових агенцій: лукбук для пітчу, зразки, брендинг клієнта, рахунок на агенцію або клієнта."),
...
{cards}
  ...
  <p class="lede">Дві 3D-версії та вісім сценаріїв для бізнес-клієнтів у стилях основних версій: 3D-ательє подарунка, 3D-історія, новорічні подарунки, річна програма, сертифікати, HoReCa, опт, агенції, події й англомовна сторінка. Ціни роздрібні з obiimy.world; корпоративні умови — пропозиція, яку має підтвердити бренд.</p>
  <div class="grid b2b">
{b2b_cards}
  </div>
...
'''
    ...
    for t in (ROOT / "thumbs-src").glob("*.jpg"):
        shutil.copy(t, SITE / "thumbs" / t.name)
